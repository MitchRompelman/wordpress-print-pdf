...
require_once('package/class/template-class.php');
require_once('package/class/content-class.php');


//require_once('package/class/test.php');
...
Class Main extends templates {
	...
	public function __construct($a = null) {	
		...
		add_action( self::WP_HEAD, array( &$this, 'pluginStyles' ) );
		// Add the plugin javascript.
		add_action( self::WP_HEAD, array( &$this, 'pluginjavascripts' ) );
		// Add the body content.
		add_action( self::WP_FOOTER, array( &$this, 'pluginBody' ) );
		...
		if(isset($_GET['pdf'])) {
			require_once('package/class/create-pdf-class.php');
			die();
		}
	...
	public function pluginBody() {
		...
		echo '
		<script>
			var text = "' . implode('', $pluginContent->createContent()) . '";
